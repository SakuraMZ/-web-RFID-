...
<html lang="en">
  ...
  %>
            ...
            <div class="tm-bg-primary-dark tm-block tm-block-settings">
              ...
              <form action="" class="tm-signup-form row"   id="reply">
                ...
                <div class="col-12">
                  <button
                    type="submit"
                    class="btn btn-primary btn-block text-uppercase" onclick="return a();">
                    Update Your Profile
                  </button>
                </div>
              </form>
    ...
    <script language="javascript">
        function a(){
            document.getElementById("reply").action="/servlet/Alter_A_Message?id=<stu.getUsername()>";


        }
        function b(){
            document.getElementById("reply").action="/servlet/Delete_A_Message?id=<stu.getUsername()>";
